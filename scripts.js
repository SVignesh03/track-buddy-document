function getRandomMessage() {
  let messages = [
    ...
    "crack the budgeting code with Track-Buddy",
    "harvest financial growth with Track-Buddy",
    "watch your money grow like a Track-Buddy",
    "unlock financial wellness, go Track-Buddy",
    "let Track-Buddy nurture your finances",
    "budgeting made as easy as Track-Buddy",
    "get nutty about budgeting with Track-Buddy",
    "savor the flavor of financial freedom, Track-Buddy-style",
    "stay cash-ewry by budgeting",
    "reach your goals, one Track-Buddy at a time",
    "track, save, and grow, the Track-Buddy way",
    "put a Track-Buddy on overspending",
    "your budget's best friend: Track-Buddy",
  ]
